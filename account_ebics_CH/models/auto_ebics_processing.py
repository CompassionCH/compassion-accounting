...
class AutoEBICSProcessing(models.AbstractModel):
    ...
    def process(self, n_days_ago=None):
        ...
        try:
            ...
            ebics_retrieved = self.env["ebics.file"].browse(output["context"]["ebics_file_ids"])
        except Exception:
        ...
        for ebics in ebics_retrieved:
            try:
                ...
                _logger.warning(f"EBICS file {ebics.display_name} could not be processed", traceback.format_exc())
