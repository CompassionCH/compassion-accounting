...
class test_recurring_contract(common.TransactionCase):
    ...
    # def test_generated_invoice(self):
        ...
        # contract_obj = self.env['recurring.contract']
        # contract_line_obj = self.env['recurring.contract.line']
        # contract = contract_obj.browse(self.contract_id)
    ...
    # def test_generated_invoice_second_scenario(self):
        ...
        # contract_obj = self.env['recurring.contract']
        # contract2 = contract_obj.browse(self.contract_id2)
        # contract_line_obj = self.env['recurring.contract.line']
        ...
        # invoicer = invoicer_obj.browse(invoicer_id)
        ...
        # new_invoicer = invoicer_obj.browse(new_invoicer_id)
        ...
        # contract_obj.copy(self.contract_id2)
        ...
        # contract_copied_act = contract_obj.browse(contract_copied_id)
    ...
    def test_generated_invoice_third_scenario(self):
        ...
        contract_term = contract_obj.browse(self.contract_id3)
