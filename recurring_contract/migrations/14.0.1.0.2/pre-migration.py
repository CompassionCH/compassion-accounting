...
def migrate(env, version):
    ...
    openupgrade.add_fields(env, [
        ...
        ('last_payment', 'account.move.line', 'account_move_line', 'date', False, 'recurring_contract', False),
        ('payment_state', 'account.move.line', 'account_move_line', 'selection', False, 'recurring_contract', False),
    ...
    if not openupgrade.table_exists(env.cr, 'account_move_recurring_contract_rel'):
        openupgrade.logged_query(env.cr, """
            ALTER TABLE account_invoice_recurring_contract_rel RENAME TO account_move_recurring_contract_rel; 
            ALTER TABLE account_move_recurring_contract_rel ADD COLUMN account_move_id INTEGER;
